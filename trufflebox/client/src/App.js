...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      const itemMgrDeployed = ItemManagerContract.networks[networkId];
      const itemDeployed = ItemContract.networks[networkId];
      
      this.itemManager= new this.web3.eth.Contract(
        ItemManagerContract.abi,
        itemMgrDeployed && itemMgrDeployed.address,
      );
      this.itemDeployed= new this.web3.eth.Contract(
        ItemContract.abi,
        itemDeployed && itemDeployed.address,
      );
